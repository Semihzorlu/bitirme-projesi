...
import { urunleriGetir, trendUrunleriGetir, etkilesimKaydet } from '../services/api';
...
function AnaSayfa() {
  ...
  const sepeteEkleHandler = (urun, e) => {
    e.preventDefault();
    e.stopPropagation();
    
    sepeteEkle(urun);
    etkilesimKaydet(urun.id, 'sepete_ekleme');
            ...
            {urunler.map((urun) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-indigo-600 font-bold text-xl mt-2">{urun.fiyat} ₺</p>
                  <button 
                    onClick={(e) => sepeteEkleHandler(urun, e)}
